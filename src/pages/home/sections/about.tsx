      ...
      <Col span={14} offset={7}>
        ...
        <p>
          <Text>
            ...
            diverse teams on a variety of projects, from <b>small startups </b>
            to <b>large enterprises</b>. Each experience has enriched my skills
            and broadened my perspective, allowing me to tackle complex
            challenges with confidence and ingenuity.
          </Text>
        </p>
        <p>
          <Text>
            I believe in the power of technology to transform businesses and
            improve lives. My approach is rooted in understanding the unique
            needs of each project and delivering <b>tailored solutions</b> that
            drive success. By combining <b>technical expertise</b> with{" "}
        ...
        <p>
          <Text>
            I am always eager to <b>collaborate</b> with like-minded
            professionals and explore new opportunities. Whether you have a
            project in mind, need a <b>consultation</b>, or just{" "}
            <b>want to network</b>, feel free to get in touch. Let's create
